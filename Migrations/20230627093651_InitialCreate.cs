        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PNRCode = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PNRInfoId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reservations_FlightDetails_FlightId",
                        column: x => x.FlightId,
                        principalTable: "FlightDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_PNRs_PNRInfoId",
                        column: x => x.PNRInfoId,
                        principalTable: "PNRs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reservations_TravelClasses_TravelClassId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TravelClassId = table.Column<int>(type: "int", nullable: false),
                    FlightId = table.Column<int>(type: "int", nullable: false),
                    flightDetailsId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SeatDetails_FlightDetails_flightDetailsId",
                        column: x => x.flightDetailsId,
                        principalTable: "FlightDetails",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SeatDetails_TravelClasses_TravelClassId",
                        column: x => x.TravelClassId,
                        principalTable: "TravelClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_PNRInfoId",
                table: "Reservations",
                column: "PNRInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_TravelClassId",
                table: "Reservations",
                column: "TravelClassId");

            migrationBuilder.CreateIndex(
                name: "IX_SeatDetails_flightDetailsId",
                table: "SeatDetails",
                column: "flightDetailsId");

            migrationBuilder.CreateIndex(
                name: "IX_SeatDetails_TravelClassId",
                table: "SeatDetails",
                column: "TravelClassId");
        }
